...
apt install -y php7.2-dev php7.2-bz2 php7.2-intl php7.2-json php7.2-opcache php7.2-readline 
apt install -y php7.2-imap php7.2-pspell php7.2-recode php7.2-sqlite3 php7.2-tidy php7.2-pgsql
apt install -y composer php7.2-bcmath
composer global require laravel/installer
cd adminpanel && composer require tcg/voyager
cp envconfig .env
